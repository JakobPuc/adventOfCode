...
public class Day1PartTwo {
    ...
    static File file = new File("Day1PartTwo.txt");
    ...
    static char[][] read() {
        ...
        String [] ref2 = {"z0oo","o1e","t2o","t3ooe","f4or","f5oe","s6x","o7oon","e8oot","n9oe"};
        try {
        ...
        //!replaces string with num
        for (int i = 0; i < arr.size(); i++) {
            for(int j = 0;j< ref.length;j++ ){
                arr. set(i, arr.get(i).toString().replace(ref[j], ref2[j]));//!more bit tko ce hocs da dela
            }
        }
        // System.out.println(arr.size());
        char[][] char2d = new char[arr.size()][];
        // System.out.println(char2d.length);2oo3
        for (int i = 0; i < arr.size(); i++) {
